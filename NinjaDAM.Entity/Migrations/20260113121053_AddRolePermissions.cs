    ...
    public partial class AddRolePermissions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissions", x => new { x.RoleId, x.PermissionDetailId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_RolePermissions_PermissionDetails_PermissionDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermissions_PermissionDetailId",
